...
# RUN mkdir /workdir
WORKDIR /home/wmaag/UROP3100/EPL_SemiDG-master/Docker_submission

## Copy your files into Docker Container
COPY ./ /home/wmaag/UROP3100/EPL_SemiDG-master/Docker_submission
RUN chmod a+x /home/wmaag/UROP3100/EPL_SemiDG-master/Docker_submission/Docker_infer.py

## Install requirements
RUN conda env create -f semi_dg.yaml
RUN pip
